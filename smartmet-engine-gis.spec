...
%changelog
* Mon Sep 29 2025 Mika Heiskanen <mika.heiskanen@fmi.fi> - 25.9.29-2.fmi
- Fixed default_epsg setting to work
...
- Force traditional axis mapping strategy for features read from the database
...
- Moved some functionality to GIS-library to avoid a dependency between Contour-engine
- Removed reading EPSG information from configuration files as obsolete, using PROJ database instead
